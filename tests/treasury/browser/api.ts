...
export const treasuryAPI = {
 getSnapshot:async()=>{const w=window as any;w.reads=(w.reads||0)+1;await new Promise(r=>setTimeout(r,w.readDelay||30));return w.failRead ? {success:false,error:'Fixture refresh unavailable'}:{success:true,data:snapshot};},
