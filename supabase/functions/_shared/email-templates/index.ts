import { render as bankingTransition } from "./banking-transition.ts";
...
export const TEMPLATES: Record<TemplateName, Renderer> = {
  ...
  "individual.mobile_app_update": (p) => mobileAppUpdate({ ...p, audience: "individual" }),
  ...
  "business.mobile_app_update": (p) => mobileAppUpdate({ ...p, audience: "business" }),
