 ...
 */ export function buildBridgeTransferBody(input) {
    const bridgeRail = (rail) => String(rail || "").toLowerCase();
    return {
        ...input.source.amount ? {
        ...
        source: {
            ...
            ...input.source.from_address ? {
                from_address: input.source.from_address
            } : {},
            ...input.source.bridge_wallet_id ? {
                bridge_wallet_id: input.source.bridge_wallet_id
            } : {},
            ...input.source.external_account_id ? {
                external_account_id: input.source.external_account_id
            } : {}
        },
        destination: {
            ...
            ...input.destination.bridge_wallet_id ? {
                bridge_wallet_id: input.destination.bridge_wallet_id
            } : {},
            ...input.destination.external_account_id ? {
                external_account_id: input.destination.external_account_id
            } : {},
            ...input.destination.deposit_id ? {
                deposit_id: input.destination.deposit_id
            } : {},
        ...
        ...input.developer_fee ? {
            developer_fee_percent: input.developer_fee.percentage == null ? undefined : String(input.developer_fee.percentage),
        ...
        ...input.sca_attestation ? {
            initiation: {
                ...
                attestations: {
                    sca: {
                        outcome: input.sca_attestation.outcome
                    }
                }
            }
        } : {}
