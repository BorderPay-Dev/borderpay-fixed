...
payload = (ROOT / "supabase/functions/_shared/providers/bridge-transfer-payload.ts").read_text()
...
if not (
    "attestations:" in payload
    and "sca:" in payload
    and "outcome: input.sca_attestation.outcome" in payload
):
