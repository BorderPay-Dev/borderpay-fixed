...
require('.from("sca_customer_scopes")' in shared and '.eq("source", "bridge_customer_api")' in shared, 'protected services must consume only current Bridge-derived scope')
require('code: "sca_scope_unavailable"' in shared, 'unknown provider scope must fail closed for protected actions')
