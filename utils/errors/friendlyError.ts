...
const ERROR_MAP: Array<{ pattern: RegExp; message: string }> = [
  { pattern: /security_enrollment_required|transaction PIN and authenticator|authenticator before requesting/i, message: 'Set up your transaction PIN and authenticator before requesting an account or wallet.' },
  ...
  { pattern: /timeout|timed out|aborted|response_unconfirmed/i, message: 'We could not confirm the response. Please try again.' },
