...
Deno.serve(async (req) => {
  ...
  return page(`<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><title>Continue verification</title><style>html,body{height:100%;margin:0;background:#0b0e11;color:#fff;font-family:Inter,system-ui,sans-serif}main{min-height:100%;display:grid;place-items:center;padding:24px;box-sizing:border-box}.card{width:min(420px,100%);border:1px solid #2a2f35;border-radius:24px;background:#15191e;padding:28px;box-sizing:border-box;text-align:center}h1{font-size:22px;margin:0 0 10px}p{color:#aab1ba;font-size:14px;line-height:1.5;margin:0 0 22px}a{display:block;border-radius:999px;background:#c7ff00;color:#050505;padding:14px 18px;font-weight:750;text-decoration:none}</style></head><body><main><section class="card"><h1>Secure business verification</h1><p>Continue in your browser to complete verification securely. Return to BorderPay when finished.</p><a href="${href}" target="_blank" rel="noopener noreferrer">Open secure verification</a></section></main></body></html>`);
});
