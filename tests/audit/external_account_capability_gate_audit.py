...
require("external_accounts: normalizeBridgeExternalAccounts(r.data)" in SOURCE,
        "Bridge list results must be normalized into the frontend external_accounts contract")
