/** ISO-3166 alpha-3 to alpha-2 conversion for Bridge list responses.
 * Data source: ISO-3166 country/territory codes. Eligibility is NOT decided
 * here; Bridge country policy remains authoritative for that decision.
 */
const ISO3_TO_ISO2: Readonly<Record<string, string>> = {
  ...
  VEN:"VE",VNM:"VN",VGB:"VG",VIR:"VI",WLF:"WF",ESH:"EH",YEM:"YE",ZMB:"ZM",ZWE:"ZW",XKX:"XK",
};

export function isoCountryCode2(value: unknown): string | null {
