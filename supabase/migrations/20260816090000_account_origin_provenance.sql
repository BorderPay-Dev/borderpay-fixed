...
-- Existing identities are not backfilled: absence means UNKNOWN.
...
drop trigger if exists account_origin_provenance_immutable on public.account_origin_provenance;
