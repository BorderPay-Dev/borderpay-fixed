...
// ── Webhook-email (best-effort only) ──────────────────────────────────────────
// KYC/KYB decision emails and receive-money transaction receipts are sent via
// logged `send-email`. Failures never block webhook processing.
