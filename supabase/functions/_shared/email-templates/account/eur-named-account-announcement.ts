...
export function render(p: Props): RenderedEmail {
  ...
  const body = `
    ...
    <p>Starting <strong>September 2, 2026</strong>, your name or registered business name will appear as the account-holder name on eligible BorderPay EUR account details and outgoing EUR payments.</p>
    ...
    <ul>
      <li>Ask anyone sending EUR to use your name or registered business name as the beneficiary—not Bridge's name.</li>
      <li>Refresh any saved deposit instructions after the upgrade.</li>
      <li>If a recipient allowlists sender names, ask them to expect your name or registered business name on future EUR payouts.</li>
    </ul>
