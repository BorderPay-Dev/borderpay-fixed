...
checks = {
    ...
    "invite redirect uses production portal": "https://portal.borderpayafrica.com/auth/callback#" in admin,
    "invite does not rely on the global Auth Site URL": "properties.hashed_token" in admin and "URLSearchParams" in admin,
