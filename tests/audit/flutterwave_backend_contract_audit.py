...
def main() -> int:
    ...
    for label, content, token in [
        ...
        ("transfer-create", create_fn, 'write_scope: "money_movement"'),
        ...
        ("transfer-create", create_fn, "source_locked_to_flutterwave: true"),
        ("transfer-create", create_fn, 'source_filter: "flutterwave"'),
        ...
        ("transfer-status", status_fn, 'read_scope: "status"'),
        ...
        ("transfer-status", status_fn, 'source_filter: "flutterwave"'),
        ...
        ("transfers-list", list_fn, 'read_scope: "history"'),
        ...
        ("transfers-list", list_fn, 'source_filter: "flutterwave"'),
        ("transfers-list", list_fn, 'direction_scope: "payout_or_receive"'),
        ("transfers-list", list_fn, 'channel_scope: "bank_or_mobile_money"'),
        ...
        ("collection-create", collection_create_fn, 'write_scope: "money_movement"'),
        ...
        ("collection-create", collection_create_fn, "source_locked_to_flutterwave: true"),
        ("collection-create", collection_create_fn, 'source_filter: "flutterwave"'),
        ...
        ("collection-status", collection_status_fn, 'read_scope: "status"'),
        ...
        ("collection-status", collection_status_fn, 'source_filter: "flutterwave"'),
        ...
        ("collections-list", collections_list_fn, 'read_scope: "history"'),
        ...
        ("collections-list", collections_list_fn, 'source_filter: "flutterwave"'),
        ("collections-list", collections_list_fn, 'direction_scope: "receive_only"'),
        ("collections-list", collections_list_fn, 'channel_scope: "bank_or_mobile_money"'),
        ...
        # Flutterwave V4 retries every non-200 response.
        ("webhook", webhook_fn, "webhook_accept_http_status: 200"),
        ("webhook", webhook_fn, 'provider: "flutterwave"'),
        ("webhook", webhook_fn, 'webhook_scope: "money_movement"'),
        ("webhook", webhook_fn, 'source_filter: "flutterwave"'),
        ("webhook", webhook_fn, "direction_scope: movementDirection"),
        ...
        ("webhook", webhook_fn, "duplicate_noop_reason"),
    ]:
