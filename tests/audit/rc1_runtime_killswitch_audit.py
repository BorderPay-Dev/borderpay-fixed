...
def main() -> int:
    ...
    workflow_contracts = {
        ".github/workflows/android-play.yml": (
            ...
            "- name: Publish Google Play name and icon",
        ),
        ".github/workflows/android-play-listing.yml": (
            "- name: Publish BorderPay name and icon",
        ),
        ".github/workflows/android-play-promote-25.yml": (
            "- name: Promote internal version 25 to production",
        ),
