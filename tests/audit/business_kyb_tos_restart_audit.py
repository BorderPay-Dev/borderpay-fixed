...
checks = {
    ...
    "KYB phase waits for provider acceptance": "shouldReturnKyb && termsAccepted" in kyb,
    "legacy clients advance only after acceptance": "phase === null && !termsAccepted" in kyb and "phase === null && termsAccepted" in kyb,
