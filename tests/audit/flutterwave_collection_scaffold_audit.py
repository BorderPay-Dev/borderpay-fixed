...
def main() -> int:
    ...
    require(
        "supabase/functions/flutterwave-collection-status/index.ts",
        r"read_scope:\s*\"status\"",
        "collection-status returns read scope marker",
        failures,
    )
    require(
        "supabase/functions/flutterwave-collection-status/index.ts",
    ...
    require(
        "supabase/functions/flutterwave-collection-status/index.ts",
        r"response_contract_version:\s*1",
        "collection-status returns response contract version marker",
        failures,
    )
    require(
        "supabase/functions/flutterwave-collection-status/index.ts",
    ...
    require(
        "supabase/functions/flutterwave-collection-status/index.ts",
        r"status_source:\s*providerStatus\s*\?\s*\"provider\"\s*:\s*\"local\"",
        "collection-status returns status source in response",
        failures,
    )
    require(
        "supabase/functions/flutterwave-collection-status/index.ts",
