...
require('bridgeEeaScaEnforcementEnabled' in shared, 'backend enforcement must have the Bridge EEA rollout gate')
require(shared.index('bridgeEeaScaEnforcementEnabled') < shared.index('resolveBridgeScaScope(params.supabase, params.userId)'), 'disabled rollout must bypass provider scope and customer restrictions')
...
protected = {
    ...
    'supabase/functions/yellowcard-jit-payout/index.ts': 'reserve_yellowcard_jit_payout',
}
