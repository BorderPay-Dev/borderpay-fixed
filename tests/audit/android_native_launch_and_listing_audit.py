...
assert "fastlane supply" not in workflow
assert "Publish Google Play name and icon" not in workflow
assert "track: internal" in workflow
assert "releaseFiles: android/app/build/outputs/bundle/release/app-release.aab" in workflow

print("Android native launch and binary-only Google Play upload gates passed.")
