import { htmlLayout, textLayout, firstName, RenderedEmail } from "../layout.ts";
...
export function render(p: IndividualAppStoreAnnouncementProps): RenderedEmail {
  ...
  const introText = `Hello ${name}, you can now download BorderPay on your iPhone.`;
  const body = `
    <p style="margin:0 0 14px;color:#111111;font-size:14px;line-height:1.65;text-align:left;">
      BorderPay is officially available on the Apple App Store. Download the app to securely access your account, manage your wallets, and make payments from your iPhone.
    </p>
