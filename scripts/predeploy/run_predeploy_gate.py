...
def stage1_repository_integrity(ci_mode: bool, allow_dirty: bool) -> StageResult:
    ...
    required_files = [
        ...
        "tests/audit/business_onboarding_lifecycle_audit.py",
        ...
        "tests/audit/kyb_backend_launcher_audit.py",
        "tests/audit/p0_native_kyb_receipt_regression_audit.py",
        "tests/audit/eurc_eu_flag_regression_audit.py",
        "tests/audit/bridge_kyb_cross_platform_callback_audit.py",
