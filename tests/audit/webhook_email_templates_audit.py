...
def main() -> int:
    ...
    # E4 — regression: 11 total registered templates
    total = len(re.findall(r'"\w+\.\w+":\s*\w', idx))
    checks.append(("E4 11 templates registered (8 existing + 3 new)", total == 11,
                   f"expected 11 registered templates, found {total}"))
