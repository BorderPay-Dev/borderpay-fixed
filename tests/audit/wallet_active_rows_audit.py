...
def assert_add_wallet_screen(src: str) -> None:
    ...
    require(src, "previewWalletAssets(scopedCountry || (!verified ? country : null))", "AddWalletScreen preview")
    require(src, "verified && scopedCountry", "AddWalletScreen approved scope")
    require(src, "card.code === 'USDT' && allowUsdtTron", "AddWalletScreen approved scope")
    require(src, "card.code === 'EURC' && allowEurcBase", "AddWalletScreen approved scope")
    require(src, "previewAssets.includes(card.code)", "AddWalletScreen preview")
