...
Deno.serve(async (req) => {
  ...
  // This authorization check must precede capabilities, pending-request writes,
  // destination resolution, and every Bridge provider call. UI gating alone is
  // not a security boundary, especially for already-installed mobile clients.
