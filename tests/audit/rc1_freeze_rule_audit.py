    ...
    for ref in ("origin/main", "main", "origin/master", "master"):
        ...
        if rc == 0:
            ...
            if files:
                ...
                return diffs
            # The first valid ref is authoritative. If HEAD currently equals
            # origin/main, inspect the working tree below; never fall through
            # to a potentially stale local `main` and resurrect old diffs.
            break
